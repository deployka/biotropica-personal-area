      ...
      <div className={s.policy}>
        ...
        <div className={s.list__element}>
          ...
          <div className={s.list__text}>
            <p>
              ...
              в сети интернет по сетевому адресу https://lk.biotropika.ru.
            </p>
          </div>
        </div>
        <div className={s.list__element}>
        ...
        <div className={s.list}>
          ...
          <div className={s.list__element}>
            ...
            <div className={s.list__text}>
              <p>
                Информацию о состоянии здоровья, результаты медицинских
                анализов, данные о тренировках.
              </p>
            </div>
          </div>
          <div className={s.list__element}>
          ...
          <div className={s.list__element}>
            ...
            <div className={s.list__text}>
              <p>
                ...
                Оператору требования, указанного в п. 5.11.3 настоящей Политики
          ...
          <div className={s.list__element}>
            ...
            <div className={s.list__text}>
              <p>
                ...
                https://lk.biotropika.ru;
                <br />– изучение данных о состоянии здоровья и результатах
                спортивных тренировок для формирования персональных рекомендаций
                от медицинских и спортивных специалистов сервиса.
              </p>
            </div>
          </div>
          <div className={s.list__element}>
            ...
            <div className={s.list__text}>
              <p>
                ...
                электронной почты vladimir0905l@yandex.ru с пометкой «Отказ от
          ...
          <div className={s.list__element}>
            ...
            <div className={s.list__text}>
              <p>
                ...
                https://lk.biotropika.ru или направленные Оператору посредством
          ...
          <div className={s.list__element}>
            ...
            <div className={s.list__text}>
              <p>
                ...
                Оператора vladimir0905l@yandex.ru с пометкой «Актуализация
                персональных данных».
              </p>
            </div>
          </div>
          <div className={s.list__element}>
            ...
            <div className={s.list__text}>
              <p>
                ...
                vladimir0905l@yandex.ru с пометкой «Отзыв согласия на обработку
                персональных данных».
              </p>
            </div>
          </div>
            ...
            <div className={s.list__element}>
              ...
              <div className={s.list__text}>
                <p>
                  ...
                  сети Интернет по адресу https://lk.biotropika.ru/policy.
                </p>
              </div>
            </div>
          </div>
