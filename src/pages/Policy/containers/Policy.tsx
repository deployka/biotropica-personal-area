    ...
    <div className={s.policy__container}>
      ...
      <div className={s.list}>
        ...
        <div className={s.list__element}>
          ...
          <div className={s.list__text}>
            <p>
              Информацию о состоянии здоровья, результаты медицинских анализов,
        ...
        <div className={s.list__element}>
          ...
          <div className={s.list__text}>
            <p>
              ...
              материалам, содержащимся на веб-сайте https://lk.biotropika.ru;
        ...
        <div className={s.list__element}>
          ...
          <div className={s.list__text}>
            <p>
              ...
              vladimir0905l@yandex.ru с пометкой «Актуализация персональных
              данных».
            </p>
          </div>
        </div>
