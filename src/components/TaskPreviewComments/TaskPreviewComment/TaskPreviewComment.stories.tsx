...
import { TaskPreviewComment, TaskPreviewCommentProps } from './TaskPreviewComment';
...
const Template: ComponentStory<typeof TaskPreviewComment> = (args: TaskPreviewCommentProps) =>
