...
import { EventTaskPreview, EventTaskPreviewProps } from './EventTaskPreview';
...
const task: EventTask = {
  ...
  date: '27.01.2022',
  status: 'init',
  description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur exercitationem repellat quos ut doloribus culpa ipsa laboriosam, a laudantium sint quis, dolorem error voluptas cumque odio voluptatem quae autem provident!',
  completionValue: '5',
  comments: [],
  id: 'feqfqwfqwfwf',
