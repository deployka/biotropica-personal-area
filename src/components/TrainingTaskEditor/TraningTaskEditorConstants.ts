...
export const kindOfSportOptions: SelectOptions<TrainingTask['kindOfSport']>[] = Object.keys(
...
export const trainingCategoryOptions: SelectOptions<TrainingTask['category']>[] = Object.keys(
...
export const firstTargetTypeOptions: SelectOptions<TrainingTask['firstTargetType']>[] = Object.keys(
...
export const secondTargetTypeOptions: SelectOptions<TrainingTask['secondTargetType']>[] = Object.keys(
