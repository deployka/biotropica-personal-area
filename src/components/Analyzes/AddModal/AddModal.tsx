...
export const AnalyzeAddModal = ({
  ...
  return (
    <>
      <div onClick={() => closeModal(ModalName.MODAL_ADD_ANALYZE_FILE)}>
        <PopupBackground open={modals.MODAL_ADD_ANALYZE_FILE.open} />
      </div>
      <Formik
        initialValues={{
          filePath: null,
        ...
        {({
          ...
          >
            ...
            <div className={s.buttons}>
              ...
              />
              <Button
                onClick={() => closeModal(ModalName.MODAL_ADD_ANALYZE_FILE)}
                options={{
