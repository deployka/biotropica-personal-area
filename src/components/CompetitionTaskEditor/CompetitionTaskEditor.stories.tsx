...
import { CompetitionTaskEditor, CompetitionTaskEditorProps } from './CompetitionTaskEditor';
import { CreateCompetitionTask, KindOfCompetitionSport, RunCompetitionType, TaskPriority } from '../../store/@types/Task';
...
const Template: ComponentStory<typeof CompetitionTaskEditor> = (args: CompetitionTaskEditorProps) =>
