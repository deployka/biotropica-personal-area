import { CyclingCompetitionType, KindOfCompetitionSport, RunCompetitionType, SkisCompetitionType, SwimCompetitionType, TaskPriority, TriathlonCompetitionType } from '../../store/@types/Task';
...
export function getTranslatedCompetitionType(
  ...
  switch (kindOfSport) {
    case 'run':
      return translatedRunCompetitionType[competitionType as RunCompetitionType];
    case 'triathlon':
      return translateTriathlonCompetitionType[competitionType as TriathlonCompetitionType];
    case 'swimming':
      return translatedSwimCompetitionType[competitionType as SwimCompetitionType];
    case 'cycling':
      return translatedCyclingCompetitionType[competitionType as CyclingCompetitionType];
    case 'skis':
      return translatedSkisCompetitionType[competitionType as SkisCompetitionType];
    default:
      return '';
  }
}
