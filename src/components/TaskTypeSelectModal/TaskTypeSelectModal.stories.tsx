...
import { TaskTypeSelectModal, TaskTypeSelectModalProps } from './TaskTypeSelectModal';
...
const Template: ComponentStory<typeof TaskTypeSelectModal> = (args: TaskTypeSelectModalProps) =>
