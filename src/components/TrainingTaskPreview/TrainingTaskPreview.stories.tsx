...
const task: TrainingTask = {
  ...
  status: 'init',
  comments: [],
  description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum quae omnis, ab sed cumque fugit suscipit eligendi, quam, fuga sint ratione praesentium doloribus saepe. Temporibus corrupti architecto ea perferendis ratione.',
  id: '213123',
  executorId: 0,
};
