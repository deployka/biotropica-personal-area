...
import { RecommendationEditor, RecommendationEditorProps } from './RecommendationEditor';
...
const Template: ComponentStory<typeof RecommendationEditor> = (args: RecommendationEditorProps) =>
