    ...
    <Formik initialValues={{}} onSubmit={save}>
      <Form className={s.form}>
        ...
        >
          ...
          >
            <path d="M8.4 1C8.731 1 9 1.269 9 1.6V7H14.4C14.731 7 15 7.269 15 7.6V8.4C15 8.731 14.731 9 14.4 9H9V14.4C9 14.731 8.731 15 8.4 15H7.6C7.269 15 7 14.731 7 14.4V9H1.6C1.269 9 1 8.731 1 8.4V7.6C1 7.269 1.269 7 1.6 7H7V1.6C7 1.269 7.269 1 7.6 1H8.4V1Z" />
          </svg>
          добавить поле
        </Button>
        ...
        {!isNew && (
          <a href="#" className={s.deleteBtn} onClick={onRemove}>
            Удалить тариф
          </a>
        )}
      </Form>
