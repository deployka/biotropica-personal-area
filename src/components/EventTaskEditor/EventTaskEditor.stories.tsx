...
import { EventTaskEditor, EventTaskEditorProps } from './EventTaskEditor';
...
const Template: ComponentStory<typeof EventTaskEditor> = (args: EventTaskEditorProps) => <EventTaskEditor {...args} />;
