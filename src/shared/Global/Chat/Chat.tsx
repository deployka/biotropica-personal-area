...
export const Chat = (props: Props) => {
    ...
    function dispatchAddMessage(newMessage: Message) {
        ...
        if(dialog) {
            ...
            const messagesIndex = messages.findIndex(it => it.uuid === newMessage.uuid);
            if (messagesIndex === -1) {
            ...
            setDialogs(dialogs.slice().splice(index, 1, {
                ...dialog,
                messages
            }))
        }
    ...
    function sendMessage(dialog: Dialog, msg: {
        type: MessageType;
        text?: string;
        fileId?: number;
    }) {
